...
/**
 * A class which performs a black elf strategy: for the child the strategy is applied to, the
 * budget is reduced by 30%.
 */
public class BlackElfStrategy implements ElfStrategy {

    /**
     * The method which represents the applied strategy: the budget is reduced by 30%
